"""
Logging estructurado con formato JSON y correlation IDs
"""
import logging
import json
import sys
...
def setup_logging(service_name: str, level: str = "INFO") -> logging.Logger:
    ...
    Args:
        service_name: Nombre del servicio (core-api, agent-ia, analytics, etc.)
...
def get_logger() -> StructuredLogger:
    ...
    if _service_logger is None:
        ...
        base_logger = setup_logging("core-api", "INFO")
